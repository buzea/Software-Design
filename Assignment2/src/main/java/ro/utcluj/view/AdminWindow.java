    ...
    private void initialize() {
        ...
        if (isDebug) {
            table.setModel(new DefaultTableModel(new Object[][]{{null, null, null, null, null, null},
                    ...
                    {null, null, null, null, null, null}, {null, null, null, null, null, null},
                    {null, null, null, null, null, null},}, EmployeeWindow.COLUMN_NAMES));
        } else {
            table.setModel(new DefaultTableModel(library.toObjectMatrix(), EmployeeWindow.COLUMN_NAMES));
        }
        ...
        userTable.setModel(new DefaultTableModel(new Object[3][3], new String[]{"Username", "Password", "Type"}));
        ...
        panel_4.add(btnShowUsers, gbc_btnShowPassword);
